...
Analysis of Sarcina's records will lean heavily on both conventional and machine learning approaches to graph analysis of the relations between users. The aim will be to bootstrap meaningful attributes and taxonomies of activity from commonalities in patterns of communications, building off the seed of user provided data such as reported occupations and quality of service.

Both supervised and unsupervised learning approaches will have a role to play in extracting the true variables and their relationships from this combination of attested but unreliable human-labeled structured data and reliable but unlabeled graph topology.

The aim of any ML model used on Sarcina data will be to bring forth some deterministically describable feature or relationship in the data. Sarcina will not as a matter of policy use any large, uninterpretable "black box" models to make inferrences about individual users or their records.
